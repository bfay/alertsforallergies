...
get_header(); ?>
		...
		<!--******************This is where you put the title of the product (remove the quotes too)**********--><h1>Allergy Alert Stickers</h1>
...
<h4>2.5″ circle</h4>
<h4>25 for $5</h4></br></br>
<p><strong>Buy in Bulk and SAVE!</strong></br>
Get 150 stickers for only $25</br>
...
<div class="left"><input type="hidden" name="currency_code" value="USD" /> <input type="image" name="submit" src="https://www.paypalobjects.com/en_US/i/btn/btn_cart_LG.gif" alt="PayPal - The safer, easier way to pay online!" /> <img src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" alt="" width="1" height="1" border="0" margin-left="12px" /></div>
</form></br></br>
...
<!--*************************This is where you put the extended information about the product.  It is the width of the page underneath everything, just like petunia.com (remove the quotes too)***************************--><div class="product-more thirteen columns centered"><p>These bright and colorful stickers help get attention and are an excellent way to label purchased and home-baked goods as "safe", so others will have no doubt what they can safely offer. Helps avoid confusion and contamination by labeling your child's drink, especially during sports and parties. A great way to mark alternative peanut butter sandwiches (ex: SunButter) as "safe" and to also mark your child's disposable lunch bags. Make important notes and letters stand out.... there are so many ways you can use them!</p>
		</div>
		</div><!--end row-->
		</div><!--end container-->
		</div><!--end main-->
